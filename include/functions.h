...
MatrixXd
fe_calJacobian(int dim, int nnel, VectorXd dndr, VectorXd dnds, VectorXd dndt, VectorXd xcoord, VectorXd ycoord,
               VectorXd zcoord);
/** dndx of actual element calculates using jacobian and shape function derivates calculated in the isoparametric element */
VectorXd
fe_dndx_8(int nnel, VectorXd dndr, VectorXd dnds, VectorXd dndt, MatrixXd invJacobian);
/** dndy of actual element calculates using jacobian and shape function derivates calculated in the isoparametric element */
VectorXd
fe_dndy_8(int nnel, VectorXd dndr, VectorXd dnds, VectorXd dndt, MatrixXd invJacobian);
/** dndz of actual element calculates using jacobian and shape function derivates calculated in the isoparametric element */
VectorXd
fe_dndz_8(int nnel, VectorXd dndr, VectorXd dnds, VectorXd dndt, MatrixXd invJacobian);
/** Strain displacement matrix B */
MatrixXd
fe_strDispMatrix(int edof, int nnel, VectorXd dndx, VectorXd dndy, VectorXd dndz);
...
MatrixXd
fe_strDispMatrix_totalLagrangian(int edof, int nnel, VectorXd dndx, VectorXd dndy, VectorXd dndz, VectorXd u);
...
VectorXd
fe_stressUpdate(VectorXd dndx, VectorXd dndy, VectorXd dndz, MatrixXd disp_mat, VectorXd u, int opt, int return_opt);
...
VectorXd
fe_mooneyrivlin_hyperelastic(VectorXd dndx, VectorXd dndy, VectorXd dndz, VectorXd u, int opt, int return_opt);
...
VectorXd
fe_newtonRhapson(VectorXd nat_coord, VectorXd xcoord, VectorXd ycoord, VectorXd zcoord);
...
VectorXd
fe_gather(VectorXd global_vec, VectorXd local_vec, VectorXi node_list, int sdof);
/** Updates a system level vector based on the element level vector */
VectorXd
fe_scatter(VectorXd global_vec, VectorXd local_vec, VectorXi node_list, int sdof);
...
/* =================================================================== */
void
fe_calculateMass(std::string type);
void
fe_calculateMassDirectLumped(int mesh_id);
void
fe_calculateMassDirectLumped_embed(int host_id, int embed_id, bool address_vr);
VectorXd
...
VectorXd
fe_getForce_3d_normal(VectorXd U, VectorXd fe, int time_step_counter, int host_id);
...
void
fe_scatterMass(VectorXd local_vec, VectorXi node_list, int sdof);
